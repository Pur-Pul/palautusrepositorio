...
from viitegeneraattori import the_viitegenetaattori_olio

class Kauppa:
    def __init__(self, varasto = the_varasto_olio, pankki = the_pankki_olio, viitegeneraattori = the_viitegenetaattori_olio):
